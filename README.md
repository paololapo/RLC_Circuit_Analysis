...
Il $\chi^2$ è inoltre intrensicamente legato alla densità di probabilità associata ad ogni parametro. Il passaggio tra le due quantità è retto dalla relazione
...
Il fatto che vi sia una differenza rispetto a quanto atteso può essere dovuto al range scelto per la mappa del $\chi^2$. Si era optato per valutare la funzione di costo nell'intervallo $(\pm2\sigma, \pm2\sigma, \pm2\sigma)$ e questo potrebbe aver portato ad un'incorretta normalizzazione della distribuzione di probabilità, mancando le code.
